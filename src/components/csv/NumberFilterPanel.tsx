...
export class NumberFilterCfgDto {
  filterType: "all" | "severity" | "probability" | "criticality" = "all";
  smallerGreaterEqual: ">=" | "<=" | "=" = ">=";
...
const NumberCfgPanel: React.FC<Props> = ({ config, handleChange }) => {
  return (
    <div className="nf-row">
      ...
      <select className="nf-filter" value={config.filterType} onChange={(e) => handleChange("filterType", e.target.value)}>
      ...
      {config.filterType !== "all" && (
        <>
          <select className="nf-operator" value={config.smallerGreaterEqual} onChange={(e) => handleChange("smallerGreaterEqual", e.target.value)}>
            <option value=">=">&gt;=</option>
            <option value="<=">&lt;=</option>
            <option value="=">=</option>
          </select>
