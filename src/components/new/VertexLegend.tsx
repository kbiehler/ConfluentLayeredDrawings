...
export const VertexLegend: React.FC = () => {
  return (
    <div className="absolute bottom-2 left-2 z-20 pointer-events-auto bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded p-2 text-xs shadow">
      {csvPropDefs.map((p) => (
